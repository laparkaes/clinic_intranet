<div class="col-md-12">
	<div class="welcome-text d-md-none d-block">
		<h4 class="text-primary mb-3"><?= $this->lang->line('surgeries') ?></h4>
	</div>
</div>
<div class="col-sm-6">
		...
		<div class="card-body">
			<div class="row bl_content" id="bl_list">
				<div class="col-md-12">
						...
						<table class="table table-responsive-md">
							<thead>
								<tr>
									...
									<th><strong><?= $this->lang->line('w_room') ?></strong></th>
					...
					<?php }else{ ?>
					<h5 class="text-danger mt-3"><?= $this->lang->line('t_no_surgeries') ?></h5>
					<?php } ?>
				</div>
			</div>
